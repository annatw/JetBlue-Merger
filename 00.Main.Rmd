...
# 2018 - 2019
merger_sim_data_generate(years_allowed =2018:2019,
                         output_file = "02.Intermediate/1819_data.rds")
# instrument_comparison_table(input_file = "02.Intermediate/1819_data.rds",
#                             output_file = "06.Tables/1819_InstrumentTable.tex")
...
blp_rcl(additional_instruments = c(hub_interactions, exog_interactions,
        ...
        precision = 1e-10); 
rcl_second_step(input = "03.Output/random_coeff_nested_logit_fs_results.pickle",
                output = "03.Output/nested_rcl_optimal.pickle",
                 precision = 1e-12)
export_rcl_output_to_latex(rcl_in = "03.Output/nested_rcl_optimal.pickle",
