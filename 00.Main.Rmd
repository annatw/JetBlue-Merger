...
destination_interactions <- c("Destination_Hub","MktMiles_DestinationHub","MktMilesSq_DestinationHub", "NonStop_DestinationHub")
    ...
    exog_interactions <- c("MktMiles_NonStop","MktMiles_Sq_NonStop","NonStop_Origin_Share","NonStop_ExtraMiles",
      "MktMiles_Sq_Interact", "MktMiles_Origin_Share","MktMiles_Extra","OriginRatio_Extra")
  ...
  gm_instruments <- gasmiles_basic <- c("GasMiles","GasMiles_Origin_Prescence", "GasMiles_NonStop")
...
# Pre-Pandemic
blp_logit_iv(additional_instruments = c(exog_interactions,
                                        hub_interactions, gm_instruments,
                                        rho_instrument),
