...
# Define Model
linear_formula <- '0 + prices + NonStop + MktMilesFlown + MktMilesFlown_Sq + Origin_Firm_Service_Ratio + Extra_Miles + Extra_Miles_Sq + Tourism + C(Year_Quarter_Effect) + C(Carrier)'
...
destination_interactions <- c("Destination_Hub","MktMiles_DestinationHub","MktMilesSq_DestinationHub", "NonStop_DestinationHub")
  ...
  gm_instruments <- c("GasMiles", "GasMiles_Sq", "GasMiles_Origin_Prescence", "GasMiles_NonStop", "GasMiles_ExtraMiles")
...
# Merger Simulation
# Basic - Captures Shared Ownership
merger_simulation_basic(model_in = "03.Output/nested_logit_iv.pickle", 
                        data_in = "02.Intermediate/Product_Data.rds",
                        data_out = "02.Intermediate/Logit_Sim_Data.rds")
merger_simulation_basic(model_in = "03.Output/pre_pandemic_nested_logit_iv.pickle",
                        data_in = "02.Intermediate/prepandemic.rds",
                        data_out = "02.Intermediate/prepandemic_Logit_Sim_Data.rds")

# Advanced - Capture Efficiencies 
merger_simulation_advanced(model_in = "03.Output/nested_logit_iv.pickle",
                          data_in = "02.Intermediate/Product_Data.rds",
                        data_out = "02.Intermediate/Logit_Sim_Adv_Data.rds",
                        mode = "logit")

merger_simulation_advanced(model_in = "03.Output/pre_pandemic_nested_logit_iv.pickle",
                        data_in = "02.Intermediate/prepandemic.rds",
                        data_out = "02.Intermediate/prepandemic_Logit_Sim_Adv_Data.rds",
                        mode = "logit")

# Elasticity Comparison Table
elasticity_compare_table(postPand_input = "03.Output/nested_logit_iv.pickle",
                         prePand_input = "03.Output/pre_pandemic_nested_logit_iv.pickle",
                         table_out = "06.Tables/Logit_Elasticity_Compare_Table.tex")
```
...
# Pre-Pandemic
merger_simulation_basic(model_in = "03.Output/prepandemic_random_coeff_nested_logit.pickle",
                           data_in = "02.Intermediate/prepandemic.rds",
...
merger_results_basic(merger_data = "03.Output/PrePandemic_Basic_Merger_Sim_Data.rds",
                                 ...
                                 rcl_file = "03.Output/prepandemic_random_coeff_nested_logit.pickle",
...
#                      rcl = "03.Output/prepandemic_random_coeff_nested_logit.pickle")
